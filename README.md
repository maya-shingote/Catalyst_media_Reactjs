...
@emotion/styled: Styling library for CSS-in-JS styling.
@mui/icons-material: Material-UI icons for UI components.
@mui/material: Material-UI components for UI design.
@testing-library/jest-dom: Testing utility for React components.
@testing-library/react: Testing utility for React components.
@testing-library/user-event: Testing utility for simulating user events.
